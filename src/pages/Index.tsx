        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold mb-6 animate-fade-in">
              Líderes en Iluminación Profesional
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto animate-slide-up">
              Más de 10 años de experiencia respaldando los mejores eventos y producciones de Argentina
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Confianza construida día a día con resultados que respaldan nuestra experiencia
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center animate-fade-in">
              ...
              <p className="text-white/90">Eventos Iluminados</p>
            </div>
