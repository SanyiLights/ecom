...
const InstagramReelCard = ({ url, title, description, color }: { 
  url: string; 
  title: string; 
  description: string;
  color: string;
            ...
            >
              <div style={{ padding: '16px' }}>
                ...
                <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  <a href={url} style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank">
                    A post shared by Sanyi Lights Argentina (@sanyilightsar)
                  </a>
                </p>
              </div>
            </blockquote>
...
export const InstagramReels = () => {
  const reels = [
    {
      url: "https://www.instagram.com/reel/DMLaS7fOaU9/",
      title: "Nuevo Cabezal Móvil LED",
      description: "Demostración en vivo del nuevo modelo Sanyi",
      color: "from-red-600 to-red-700"
    },
    {
      url: "https://www.instagram.com/reel/DLprHr3uWNG/",
      title: "LED Display Profesional",
      description: "Configuración para eventos masivos",
      color: "from-red-500 to-red-600"
    },
    {
      url: "https://www.instagram.com/reel/DLlP7pyuQEq/",
      title: "Consola DMX Avanzada",
      description: "Control total de iluminación escénica",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <div className="flex items-center justify-center mb-4">
            <Instagram className={`h-8 w-8 ${colors.primary.text} mr-3`} />
            <h2 className={`text-3xl sm:text-4xl lg:text-5xl font-bold ${colors.primary.gradient} bg-clip-text text-transparent`}>
              Productos Nuevos
            </h2>
          </div>
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
            Descubre nuestros últimos productos en acción a través de nuestros reels de Instagram
          </p>
        </div>
        ...
        <div className="text-center">
          <div className={`bg-gradient-to-r ${colors.primary.bg10} rounded-3xl p-8 sm:p-12 border ${colors.primary.border}`}>
            <h3 className="text-2xl sm:text-3xl font-bold mb-4 text-foreground">
              ¿Quieres ver más contenido?
            </h3>
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Síguenos en Instagram para estar al día con nuestros últimos productos, 
              eventos y novedades en iluminación profesional.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/productos" onClick={() => window.scrollTo(0, 0)}>
                <Button 
                  size="lg" 
                  variant="outline"
                  className={`border-2 ${colors.primary.border} hover:bg-muted`}
                >
